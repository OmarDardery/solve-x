  ...
  if (!organization) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 mb-6">The organization you're looking for doesn't exist.</p>
        <Link to="/events">
        ...
        <CardContent>
          {events.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">This organization hasn't posted any events yet.</p>
            </div>
          ) : (
